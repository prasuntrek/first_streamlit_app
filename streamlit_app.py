...
# New Section to Display Fruity Vice Fruit Advice 
...
# Next line displays the Fruit Advice data in table format
fruityvice_normalized = pandas.json_normalize(fruityvice_response.json())
# write your own comment - what does this do?
streamlit.dataframe(fruityvice_normalized)


#Stop any code to run from this point
streamlit.stop()
...
my_cur1.execute("SELECT CURRENT_USER(), CURRENT_ACCOUNT(), CURRENT_REGION()")
